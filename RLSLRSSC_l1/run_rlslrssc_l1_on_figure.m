function [ output_args ] =  run_rlslrssc_l1_on_figure(db_name, process_mode, option)
dir_base = '~/RLSLRSSC/';
algorithm_name = 'RLSLRSSC_L1';
if nargin < 2
db_name = 'MNIST_reduced_contrast_awgn1';
process_mode = 'Random500';
end
...
if nargin == 2
    for reducedDim=[100]
        for lambda = [0.001,0.01]
            for lambda1=[0.001,0.01]
